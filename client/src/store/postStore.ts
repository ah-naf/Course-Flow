...
interface PostState {
  ...
  getCommentLink: (classId: string, postId: string, commentId: string) => string;
}
      ...
      posts: [
        {
          ...
          user: { id: "instructor", name: "Sarah Johnson", initial: "S" },
          comments: [
            {
              id: "comment1",
              content:
                "Looking forward to the course! Will we be using any specific state management libraries?",
              user: { id: "user1", name: "Alex Smith", initial: "A" },
              timestamp: new Date(
          ...
          comments: [
            {
              ...
              user: { id: "user3", name: "Raj Patel", initial: "R" },
              timestamp: new Date(
            ...
            },
            {
              ...
              user: { id: "user2", name: "Jamie Wong", initial: "J" },
              timestamp: new Date(
